...
| **Admin** | `users.role = 'admin'` | Everything a User can, plus manage accounts, read the AI spend and safety queues, and manage topics, categories, docs, questions and Shadowing video lessons |
