...
import { getTopic, listDocuments, listRooms } from "@/lib/api";
  ...
  return (
    <>
      ...
      <section className="container-page py-10 grid lg:grid-cols-12 gap-5">
        <div className="lg:col-span-5 rounded-4xl bg-cream border border-border p-7">
          <h2 className="text-2xl text-ink">Learning notes</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Trusted material for this topic. The in-room AI coach uses these too.
          </p>
          {docsQ.isLoading ? (
            ...
            <ul className="mt-5 space-y-2.5">
              {documents.map((d) => (
                <li key={d.id} className="rounded-2xl border border-border bg-card px-4 py-3">
